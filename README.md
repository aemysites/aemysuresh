...
## Environments
- Preview: https://main--aemysuresh--aemysites.aem.page/
- Live: https://main--aemysuresh--aemysites.aem.live/
- Block Library: https://main--aemysuresh--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `aemysuresh` directory in your favorite IDE and start coding :)
